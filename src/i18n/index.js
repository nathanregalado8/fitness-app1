...
const STRINGS = {
  ...
  blockWeek: { en: 'Block {block} · Week {week}', es: 'Bloque {block} · Semana {week}' },
  sinceMonth: { en: 'Since {month}', es: 'Desde {month}' },
  sessionsCount: { en: '{n} sessions', es: '{n} sesiones' },
  avoidedWhenSuggesting: { en: 'avoided when suggesting', es: 'se evitan al sugerir' },
  ...
  askName: { en: 'What should we call you?', es: '¿Cómo te llamamos?' },
  ...
  // ----------------------------------------------------------------- chat
  stepChat: { en: '02 — COACH', es: '02 — ENTRENADOR' },
  chatTitle: { en: 'Talk to your coach', es: 'Habla con tu entrenador' },
  chatTab: { en: 'Chat', es: 'Chat' },
  viewSession: { en: 'Session', es: 'Sesión' },
  chatNote: {
    en: 'It reads your signals, never your raw log. Anything it changes shows up as a button you press.',
    es: 'Lee tus señales, nunca tu registro crudo. Lo que cambie aparece como un botón que tú aprietas.',
  },
  chatPlaceholder: { en: 'Write to your coach…', es: 'Escríbele a tu entrenador…' },
  send: { en: 'Send', es: 'Enviar' },
  clearChat: { en: 'Clear', es: 'Limpiar' },
  applied: { en: 'Applied', es: 'Aplicado' },
  prop_set_target: { en: 'Target for next time', es: 'Objetivo para la próxima' },
  prop_flag_concern: { en: 'Flag a sensitive area', es: 'Marcar zona sensible' },
  prop_clear_concern: { en: 'Clear a sensitive area', es: 'Quitar zona sensible' },
  prop_set_profile: { en: 'Change your profile', es: 'Cambiar tu perfil' },
  prop_set_equipment: { en: 'Equipment', es: 'Equipamiento' },
  prop_build_session: { en: 'Session ready to start', es: 'Sesión lista para empezar' },
  chatSeedHeavy: { en: 'Should I go heavier on bench?', es: '¿Subo peso en press de banca?' },
  chatSeedTired: { en: 'I am beat up this week', es: 'Vengo machacado esta semana' },
  chatSeedPlateau: { en: 'What is stalling right now?', es: '¿Qué está estancado ahora mismo?' },
  chatSeedWeak: { en: 'What am I neglecting?', es: '¿Qué estoy descuidando?' },
